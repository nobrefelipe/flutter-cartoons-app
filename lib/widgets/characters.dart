...
List characters = [
  ...
  Character(
    ...
    imagePath: "assets/images/pikachu-hd.png",
    colors: [Colors.yellow.shade700, Color.fromRGBO(225, 151, 32, 1)]
  ),
  ...
  Character(
    ...
    colors: [Color.fromRGBO(0, 122, 195, 1), Color.fromRGBO(0, 41, 98, 1)]
  ),
  ...
  Character(
    ...
    imagePath: "assets/images/super-mario-2.png",
    colors: [Colors.red.shade400, Color.fromRGBO(229, 37, 33, 1)]
  ),
